...
template Main() {
    ...
    */
    ...
    perlin.p[0] <== x;
    perlin.p[1] <== y;
    perlin.KEY <== treasureSeed;
    perlin.SCALE <== 2;
    perlin.xMirror <== 0;
    perlin.yMirror <== 0;
    treasurePerlin === perlin.out; */
...
component main { public [terrainSeed, fogSeed, treasureSeed, terrainPerlin, treasurePerlin, width, height] } = Main();