...
export interface GoldAmountComponentInterface extends utils.Interface {
  functions: {
...
export interface GoldAmountComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GoldAmountComponentInterface;
