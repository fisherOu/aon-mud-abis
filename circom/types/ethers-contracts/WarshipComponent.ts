...
export type WarshipStruct = {
  model: PromiseOrValue<string>;
  createTime: PromiseOrValue<BigNumberish>;
};

export type WarshipStructOutput = [string, BigNumber] & {
  model: string;
  createTime: BigNumber;
};

export interface WarshipComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, WarshipStruct]
  ): string;
  encodeFunctionData(
...
export interface WarshipComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WarshipComponentInterface;
