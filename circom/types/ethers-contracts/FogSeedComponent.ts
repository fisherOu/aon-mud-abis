...
export interface FogSeedComponentInterface extends utils.Interface {
  functions: {
...
export interface FogSeedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FogSeedComponentInterface;
