...
export type MoveConfigStruct = {
  initPoints: PromiseOrValue<BigNumberish>;
...
export interface MoveConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MoveConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(overrides?: CallOverrides): Promise<[MoveConfigStructOutput]>;
