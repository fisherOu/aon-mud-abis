...
export interface TerrainComponentInterface extends utils.Interface {
  functions: {
...
export interface TerrainComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TerrainComponentInterface;
