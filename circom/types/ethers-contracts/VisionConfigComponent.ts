...
export type VisionConfigStruct = {
  remainTime: PromiseOrValue<BigNumberish>;
  maxDistance: PromiseOrValue<BigNumberish>;
};

export type VisionConfigStructOutput = [BigNumber, BigNumber] & {
  remainTime: BigNumber;
  maxDistance: BigNumber;
};

export interface VisionConfigComponentInterface extends utils.Interface {
  functions: {
    ...
    "set((uint64,uint64))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "set((uint64,uint64))",
    values: [VisionConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface VisionConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VisionConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(overrides?: CallOverrides): Promise<[VisionConfigStructOutput]>;
    ...
    "set((uint64,uint64))"(
      visionConfig: VisionConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
