...
export type MapConfigStruct = {
  resourceDifficulty: PromiseOrValue<BigNumberish>;
  treasureDifficulty: PromiseOrValue<BigNumberish>;
  gameOriginX: PromiseOrValue<BigNumberish>;
  gameOriginY: PromiseOrValue<BigNumberish>;
  gameRadiusX: PromiseOrValue<BigNumberish>;
  gameRadiusY: PromiseOrValue<BigNumberish>;
  decimals: PromiseOrValue<BigNumberish>;
};

export type MapConfigStructOutput = [
  BigNumber,
  BigNumber,
  BigNumber,
  BigNumber,
  ...
  resourceDifficulty: BigNumber;
  treasureDifficulty: BigNumber;
  gameOriginX: BigNumber;
  gameOriginY: BigNumber;
  gameRadiusX: BigNumber;
  gameRadiusY: BigNumber;
  decimals: BigNumber;
};

export interface MapConfigv2ComponentInterface extends utils.Interface {
  functions: {
    ...
    "set((uint64,uint64,uint64,uint64,uint64,uint64,uint64))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "registerWorld"
      | "remove"
      | "set((uint64,uint64,uint64,uint64,uint64,uint64,uint64))"
      | "set(uint256,bytes)"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
  ...
  encodeFunctionData(
    functionFragment: "set((uint64,uint64,uint64,uint64,uint64,uint64,uint64))",
...
export interface MapConfigv2Component extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MapConfigv2ComponentInterface;
