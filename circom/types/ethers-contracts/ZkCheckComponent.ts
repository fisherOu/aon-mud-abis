...
export interface ZkCheckComponentInterface extends utils.Interface {
  functions: {
...
export interface ZkCheckComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZkCheckComponentInterface;
