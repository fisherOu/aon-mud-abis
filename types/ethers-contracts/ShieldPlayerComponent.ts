...
export interface ShieldPlayerComponentInterface extends utils.Interface {
  functions: {
...
export interface ShieldPlayerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShieldPlayerComponentInterface;
