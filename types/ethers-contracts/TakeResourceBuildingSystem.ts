...
export type TakeInfoStruct = {
  ...
  resourceBuildingId: PromiseOrValue<BigNumberish>;
};
...
export type TakeInfoStructOutput = [
  ...
  resourceBuildingId: BigNumber;
};

export interface TakeResourceBuildingSystemInterface extends utils.Interface {
  functions: {
...
export interface TakeResourceBuildingSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TakeResourceBuildingSystemInterface;
