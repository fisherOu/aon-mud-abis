...
export type AttackChargeStruct = {
  coord_hash: PromiseOrValue<BigNumberish>;
  direction: PromiseOrValue<BigNumberish>;
};

export type AttackChargeStructOutput = [BigNumber, BigNumber] & {
  coord_hash: BigNumber;
  direction: BigNumber;
};

export interface AttackChargeComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, AttackChargeStruct]
  ): string;
  encodeFunctionData(
...
export interface AttackChargeComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AttackChargeComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[AttackChargeStructOutput]>;
    ...
    "set(uint256,(uint256,uint256))"(
      entity: PromiseOrValue<BigNumberish>,
      attackCharge: AttackChargeStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
