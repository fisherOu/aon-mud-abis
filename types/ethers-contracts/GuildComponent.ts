...
export type GuildStruct = {
  leader: PromiseOrValue<BigNumberish>;
...
export interface GuildComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint256,string,string,string,uint64,uint32,uint32,uint256))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint256,string,string,string,uint64,uint32,uint32,uint256))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,string,string,string,uint64,uint32,uint32,uint256))",
    values: [PromiseOrValue<BigNumberish>, GuildStruct]
  ): string;
  encodeFunctionData(
...
export interface GuildComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildComponentInterface;
