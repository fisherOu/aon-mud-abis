...
export type ChargingStruct = {
  chargingEntity: PromiseOrValue<BigNumberish>;
  chargingTimeout: PromiseOrValue<BigNumberish>;
};

export type ChargingStructOutput = [BigNumber, BigNumber] & {
  chargingEntity: BigNumber;
  chargingTimeout: BigNumber;
};

export interface ChargingComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint256,uint64))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,uint64))",
    values: [PromiseOrValue<BigNumberish>, ChargingStruct]
  ): string;
  encodeFunctionData(
...
export interface ChargingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChargingComponentInterface;
