...
export interface BuffBelongingComponentInterface extends utils.Interface {
  functions: {
...
export interface BuffBelongingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuffBelongingComponentInterface;
