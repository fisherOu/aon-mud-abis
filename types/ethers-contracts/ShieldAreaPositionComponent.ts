...
export interface ShieldAreaPositionComponentInterface extends utils.Interface {
  functions: {
...
export interface ShieldAreaPositionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShieldAreaPositionComponentInterface;
