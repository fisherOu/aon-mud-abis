...
export interface AttackFinishv2SystemInterface extends utils.Interface {
  functions: {
...
export interface AttackFinishv2System extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AttackFinishv2SystemInterface;
