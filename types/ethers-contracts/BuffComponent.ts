...
export type BuffStruct = {
  buffType: PromiseOrValue<BigNumberish>;
  buffLevel: PromiseOrValue<BigNumberish>;
  ...
  buffTimeout: PromiseOrValue<BigNumberish>;
};

export type BuffStructOutput = [
  BigNumber,
  number,
  string,
  BigNumber,
  ...
  isAdd: boolean;
  buffValue: BigNumber;
  buffTimeout: BigNumber;
};

export interface BuffComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint256,uint32,string,uint256,uint256,bool,uint64,uint64))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "registerWorld"
      | "remove"
      | "set(uint256,(uint256,uint32,string,uint256,uint256,bool,uint64,uint64))"
      | "set(uint256,bytes)"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,uint32,string,uint256,uint256,bool,uint64,uint64))",
    values: [PromiseOrValue<BigNumberish>, BuffStruct]
  ): string;
  encodeFunctionData(
...
export interface BuffComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuffComponentInterface;
