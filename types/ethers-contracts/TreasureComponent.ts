...
export type TreasureStruct = {
  ...
  baseType: PromiseOrValue<string>;
};

export type TreasureStructOutput = [BigNumber, string] & {
  energy: BigNumber;
  baseType: string;
};

export interface TreasureComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint256,string))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,string))",
...
export interface TreasureComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureComponentInterface;
