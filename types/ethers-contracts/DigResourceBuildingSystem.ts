...
export interface DigResourceBuildingSystemInterface extends utils.Interface {
  functions: {
...
export interface DigResourceBuildingSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DigResourceBuildingSystemInterface;
