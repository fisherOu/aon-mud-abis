...
export type ResourceBuildingStruct = {
  value: PromiseOrValue<BigNumberish>;
  timeout: PromiseOrValue<BigNumberish>;
};

export type ResourceBuildingStructOutput = [number, BigNumber] & {
  value: number;
  timeout: BigNumber;
};

export interface ResourceBuildingComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, ResourceBuildingStruct]
  ): string;
  encodeFunctionData(
...
export interface ResourceBuildingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceBuildingComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ResourceBuildingStructOutput]>;
    ...
    "set(uint256,(uint32,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      resourceBuilding: ResourceBuildingStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
