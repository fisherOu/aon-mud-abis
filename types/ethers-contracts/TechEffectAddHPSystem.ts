...
export interface TechEffectAddHPSystemInterface extends utils.Interface {
  functions: {
...
export interface TechEffectAddHPSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechEffectAddHPSystemInterface;
