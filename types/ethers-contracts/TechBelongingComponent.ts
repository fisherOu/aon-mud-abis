...
export interface TechBelongingComponentInterface extends utils.Interface {
  functions: {
...
export interface TechBelongingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechBelongingComponentInterface;
