...
export interface GuildTechFinishSystemInterface extends utils.Interface {
  functions: {
...
export interface GuildTechFinishSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildTechFinishSystemInterface;
