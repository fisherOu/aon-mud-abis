...
export type BuffConfigStruct = {
  ...
  continueTime: PromiseOrValue<BigNumberish>;
};
...
export type BuffConfigStructOutput = [
  ...
  name: string;
  buffType: BigNumber;
  continueTime: BigNumber;
};

export interface BuffConfigComponentInterface extends utils.Interface {
  functions: {
...
export interface BuffConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuffConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[BuffConfigStructOutput]>;
