...
export type ResourceTypeConfigStruct = {
  resource0Rarely: PromiseOrValue<BigNumberish>;
  resource1Rarely: PromiseOrValue<BigNumberish>;
  resource2Rarely: PromiseOrValue<BigNumberish>;
};

export type ResourceTypeConfigStructOutput = [
  BigNumber,
  BigNumber,
  BigNumber
] & {
  resource0Rarely: BigNumber;
  resource1Rarely: BigNumber;
  resource2Rarely: BigNumber;
};

export interface ResourceTypeConfigComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [ResourceTypeConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface ResourceTypeConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceTypeConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(
      overrides?: CallOverrides
    ): Promise<[ResourceTypeConfigStructOutput]>;
    ...
    "set((uint256,uint256,uint256))"(
      resourceConfig: ResourceTypeConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  getValue(overrides?: CallOverrides): Promise<ResourceTypeConfigStructOutput>;
