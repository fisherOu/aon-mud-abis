...
export type DevConfigStruct = { devMode: PromiseOrValue<boolean> };

export type DevConfigStructOutput = [boolean] & { devMode: boolean };

export interface DevConfigComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "set((bool))",
    values: [DevConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface DevConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DevConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(overrides?: CallOverrides): Promise<[DevConfigStructOutput]>;
