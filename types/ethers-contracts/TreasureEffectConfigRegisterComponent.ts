...
export interface TreasureEffectConfigRegisterComponentInterface
...
export interface TreasureEffectConfigRegisterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureEffectConfigRegisterComponentInterface;
