...
export type JoinInfoStructOutput = [
  BigNumber,
  BigNumber,
  BigNumber,
  BigNumber,
...
export interface GuildUnfrozenSystemInterface extends utils.Interface {
  functions: {
...
export interface GuildUnfrozenSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildUnfrozenSystemInterface;
