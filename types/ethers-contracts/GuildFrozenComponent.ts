...
export interface GuildFrozenComponentInterface extends utils.Interface {
  functions: {
...
export interface GuildFrozenComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildFrozenComponentInterface;
