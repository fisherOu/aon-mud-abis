...
export interface ResourceBuildingAreaBuildingComponentInterface
...
export interface ResourceBuildingAreaBuildingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceBuildingAreaBuildingComponentInterface;
