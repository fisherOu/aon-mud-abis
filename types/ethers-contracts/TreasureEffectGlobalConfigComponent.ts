...
export type TreasureEffectGlobalConfigStruct = {
  effectGroups: PromiseOrValue<BigNumberish>[];
  effectGroupRarely: PromiseOrValue<BigNumberish>[];
  effectGroupName: PromiseOrValue<string>[];
  minEnergy: PromiseOrValue<BigNumberish>;
  maxEnergy: PromiseOrValue<BigNumberish>;
};

export type TreasureEffectGlobalConfigStructOutput = [
  number[],
  BigNumber[],
  string[],
  BigNumber,
  ...
  effectGroups: number[];
  effectGroupRarely: BigNumber[];
  effectGroupName: string[];
  minEnergy: BigNumber;
  maxEnergy: BigNumber;
};

export interface TreasureEffectGlobalConfigComponentInterface
  ...
  functions: {
    ...
    "set((uint32[],uint64[],string[],uint64,uint64))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "registerWorld"
      | "remove"
      | "set((uint32[],uint64[],string[],uint64,uint64))"
      | "set(uint256,bytes)"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
  ...
  encodeFunctionData(
    functionFragment: "set((uint32[],uint64[],string[],uint64,uint64))",
    values: [TreasureEffectGlobalConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface TreasureEffectGlobalConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureEffectGlobalConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(
      overrides?: CallOverrides
    ): Promise<[TreasureEffectGlobalConfigStructOutput]>;
    ...
    "set((uint32[],uint64[],string[],uint64,uint64))"(
      mapConfig: TreasureEffectGlobalConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
