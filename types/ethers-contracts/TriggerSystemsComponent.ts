...
export interface TriggerSystemsComponentInterface extends utils.Interface {
  functions: {
...
export interface TriggerSystemsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TriggerSystemsComponentInterface;
