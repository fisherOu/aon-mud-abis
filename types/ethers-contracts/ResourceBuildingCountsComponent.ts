...
export interface ResourceBuildingCountsComponentInterface
...
export interface ResourceBuildingCountsComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceBuildingCountsComponentInterface;
