...
export interface EnergyAmountComponentInterface extends utils.Interface {
  functions: {
...
export interface EnergyAmountComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EnergyAmountComponentInterface;
