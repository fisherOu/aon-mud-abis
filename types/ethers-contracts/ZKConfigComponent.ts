...
export type ZKConfigStructOutput = [boolean, string, string] & {
  open: boolean;
...
export interface ZKConfigComponentInterface extends utils.Interface {
  functions: {
    ...
    "set((bool,address,address))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "set((bool,address,address))",
