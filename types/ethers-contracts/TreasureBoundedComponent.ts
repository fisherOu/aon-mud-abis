...
export type TreasureBoundedStruct = {
  boundTime: PromiseOrValue<BigNumberish>;
  timeout: PromiseOrValue<BigNumberish>;
};

export type TreasureBoundedStructOutput = [BigNumber, BigNumber] & {
  boundTime: BigNumber;
  timeout: BigNumber;
};

export interface TreasureBoundedComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, TreasureBoundedStruct]
  ): string;
  encodeFunctionData(
...
export interface TreasureBoundedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureBoundedComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TreasureBoundedStructOutput]>;
    ...
    "set(uint256,(uint64,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      treasureBounded: TreasureBoundedStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
