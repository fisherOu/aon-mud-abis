...
export interface ResourceBuildingPlayerComponentInterface
...
export interface ResourceBuildingPlayerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceBuildingPlayerComponentInterface;
