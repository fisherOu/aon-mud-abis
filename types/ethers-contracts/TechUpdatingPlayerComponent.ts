...
export interface TechUpdatingPlayerComponentInterface extends utils.Interface {
  functions: {
...
export interface TechUpdatingPlayerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechUpdatingPlayerComponentInterface;
