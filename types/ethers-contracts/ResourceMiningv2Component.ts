...
export type ResourceMiningStruct = {
  remain: PromiseOrValue<BigNumberish>;
  cache: PromiseOrValue<BigNumberish>;
  lastMineTime: PromiseOrValue<BigNumberish>;
};

export type ResourceMiningStructOutput = [BigNumber, BigNumber, BigNumber] & {
  remain: BigNumber;
  cache: BigNumber;
  lastMineTime: BigNumber;
};

export interface ResourceMiningv2ComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, ResourceMiningStruct]
  ): string;
  encodeFunctionData(
...
export interface ResourceMiningv2Component extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceMiningv2ComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ResourceMiningStructOutput]>;
    ...
    "set(uint256,(uint256,uint256,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      resourceMining: ResourceMiningStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
