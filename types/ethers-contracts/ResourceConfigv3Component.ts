...
export type ResourceConfigStruct = {
  ...
  recuitTime: PromiseOrValue<BigNumberish>;
};
...
export type ResourceConfigStructOutput = [
  ...
  recuitTime: BigNumber;
};

export interface ResourceConfigv3ComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, ResourceConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface ResourceConfigv3Component extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceConfigv3ComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ResourceConfigStructOutput]>;
