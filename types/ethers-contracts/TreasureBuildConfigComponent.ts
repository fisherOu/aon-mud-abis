...
export interface TreasureBuildConfigComponentInterface extends utils.Interface {
  functions: {
    "authorizeWriter(address)": FunctionFragment;
    "getEntities()": FunctionFragment;
    "getEntitiesWithValue(uint64)": FunctionFragment;
    ...
    "set(uint64)": FunctionFragment;
    "set(uint256,bytes)": FunctionFragment;
    "set(uint256,uint64)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getEntitiesWithValue(uint64)",
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,uint64)",
...
export interface TreasureBuildConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureBuildConfigComponentInterface;
