...
export interface GuildCrestPendingComponentInterface extends utils.Interface {
  functions: {
...
export interface GuildCrestPendingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildCrestPendingComponentInterface;
