...
export type TechStruct = {
  level: PromiseOrValue<BigNumberish>;
  updateTime: PromiseOrValue<BigNumberish>;
  techGroupId: PromiseOrValue<BigNumberish>;
};

export type TechStructOutput = [BigNumber, BigNumber, BigNumber] & {
  level: BigNumber;
  updateTime: BigNumber;
  techGroupId: BigNumber;
};

export interface TechComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint64,uint64,uint256))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint64,uint64,uint256))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint64,uint64,uint256))",
    values: [PromiseOrValue<BigNumberish>, TechStruct]
  ): string;
  encodeFunctionData(
...
export interface TechComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechComponentInterface;
