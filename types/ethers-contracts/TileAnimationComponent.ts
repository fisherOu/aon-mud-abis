...
export type TileAnimationStruct = {
  animation: PromiseOrValue<string>;
  timeout: PromiseOrValue<BigNumberish>;
};

export type TileAnimationStructOutput = [string, BigNumber] & {
  animation: string;
  timeout: BigNumber;
};

export interface TileAnimationComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(string,uint64))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(string,uint64))",
    values: [PromiseOrValue<BigNumberish>, TileAnimationStruct]
  ): string;
  encodeFunctionData(
...
export interface TileAnimationComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TileAnimationComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TileAnimationStructOutput]>;
