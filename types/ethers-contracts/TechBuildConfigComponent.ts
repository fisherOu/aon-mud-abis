...
export interface TechBuildConfigComponentInterface extends utils.Interface {
  functions: {
...
export interface TechBuildConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechBuildConfigComponentInterface;
