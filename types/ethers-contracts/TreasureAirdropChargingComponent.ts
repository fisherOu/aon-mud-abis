...
export type TreasureAirdropChargingStruct = {
  coordHash: PromiseOrValue<BigNumberish>;
  area: PromiseOrValue<BigNumberish>;
};

export type TreasureAirdropChargingStructOutput = [BigNumber, BigNumber] & {
  coordHash: BigNumber;
  area: BigNumber;
};

export interface TreasureAirdropChargingComponentInterface
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, TreasureAirdropChargingStruct]
  ): string;
  encodeFunctionData(
...
export interface TreasureAirdropChargingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureAirdropChargingComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TreasureAirdropChargingStructOutput]>;
    ...
    "set(uint256,(uint256,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      treasureAirdropCharging: TreasureAirdropChargingStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
