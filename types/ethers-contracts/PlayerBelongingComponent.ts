...
export interface PlayerBelongingComponentInterface extends utils.Interface {
  functions: {
...
export interface PlayerBelongingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PlayerBelongingComponentInterface;
