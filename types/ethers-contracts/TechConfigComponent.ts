...
export type TechConfigStruct = {
  ...
  accelerateResourceRatio: PromiseOrValue<BigNumberish>;
  cancelResourceRatio: PromiseOrValue<BigNumberish>;
};

export type TechConfigStructOutput = [
  BigNumber,
  BigNumber,
  BigNumber,
  BigNumber,
  ...
  accelerateResourceRatio: number;
  cancelResourceRatio: number;
};

export interface TechConfigComponentInterface extends utils.Interface {
  functions: {
...
export interface TechConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TechConfigStructOutput]>;
