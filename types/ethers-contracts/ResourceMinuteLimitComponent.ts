...
export type ResourceMinuteLimitStruct = {
  minute: PromiseOrValue<BigNumberish>;
  count: PromiseOrValue<BigNumberish>;
};

export type ResourceMinuteLimitStructOutput = [BigNumber, BigNumber] & {
  minute: BigNumber;
  count: BigNumber;
};

export interface ResourceMinuteLimitComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, ResourceMinuteLimitStruct]
  ): string;
  encodeFunctionData(
...
export interface ResourceMinuteLimitComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceMinuteLimitComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[ResourceMinuteLimitStructOutput]>;
    ...
    "set(uint256,(uint256,uint256))"(
      entity: PromiseOrValue<BigNumberish>,
      resourceMinuteLimit: ResourceMinuteLimitStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
