...
export interface APLimitComponentInterface extends utils.Interface {
  functions: {
...
export interface APLimitComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: APLimitComponentInterface;
