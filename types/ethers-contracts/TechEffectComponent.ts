...
export type TechEffectStruct = {
  techEffectId: PromiseOrValue<BigNumberish>;
  techEffectLevel: PromiseOrValue<BigNumberish>;
  techEffectType: PromiseOrValue<BigNumberish>;
  buffValue: PromiseOrValue<BigNumberish>;
  source: PromiseOrValue<string>;
};

export type TechEffectStructOutput = [
  BigNumber,
  BigNumber,
  BigNumber,
  BigNumber,
  ...
  techEffectLevel: BigNumber;
  techEffectType: BigNumber;
  buffValue: BigNumber;
  source: string;
};

export interface TechEffectComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint256,uint256,uint64,uint64,string))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint256,uint256,uint64,uint64,string))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint256,uint256,uint64,uint64,string))",
    values: [PromiseOrValue<BigNumberish>, TechEffectStruct]
  ): string;
  encodeFunctionData(
...
export interface TechEffectComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechEffectComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TechEffectStructOutput]>;
