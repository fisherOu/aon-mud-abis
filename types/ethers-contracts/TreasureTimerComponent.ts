...
export type TreasureTimerStruct = {
  cooldown_timeout: PromiseOrValue<BigNumberish>;
  charging_timeout: PromiseOrValue<BigNumberish>;
};

export type TreasureTimerStructOutput = [BigNumber, BigNumber] & {
  cooldown_timeout: BigNumber;
  charging_timeout: BigNumber;
};

export interface TreasureTimerComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint64,uint64))": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint64,uint64))",
    values: [PromiseOrValue<BigNumberish>, TreasureTimerStruct]
  ): string;
  encodeFunctionData(
...
export interface TreasureTimerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureTimerComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TreasureTimerStructOutput]>;
    ...
    "set(uint256,(uint64,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      treasureTimer: TreasureTimerStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
