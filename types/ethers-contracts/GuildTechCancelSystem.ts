...
export interface GuildTechCancelSystemInterface extends utils.Interface {
  functions: {
...
export interface GuildTechCancelSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildTechCancelSystemInterface;
