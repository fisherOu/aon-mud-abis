...
export interface ResourceConfigLevelComponentInterface extends utils.Interface {
  functions: {
...
export interface ResourceConfigLevelComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceConfigLevelComponentInterface;
