...
export interface KillGuildCounterComponentInterface extends utils.Interface {
  functions: {
...
export interface KillGuildCounterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KillGuildCounterComponentInterface;
