...
export interface TreasurePickedComponentInterface extends utils.Interface {
  functions: {
...
export interface TreasurePickedComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasurePickedComponentInterface;
