...
export interface ResourceBuildingAreaPositionComponentInterface
...
export interface ResourceBuildingAreaPositionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceBuildingAreaPositionComponentInterface;
