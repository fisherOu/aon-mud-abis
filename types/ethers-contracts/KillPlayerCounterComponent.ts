...
export interface KillPlayerCounterComponentInterface extends utils.Interface {
  functions: {
...
export interface KillPlayerCounterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KillPlayerCounterComponentInterface;
