...
export type GuildConfigStruct = {
  createCost: PromiseOrValue<BigNumberish>;
  initTaxRate: PromiseOrValue<BigNumberish>;
  basicCountLimit: PromiseOrValue<BigNumberish>;
  initNameForLevel0: PromiseOrValue<string>;
  initNameForLevel1: PromiseOrValue<string>;
...
export type GuildConfigStructOutput = [
  ...
  initTaxRate: number;
  basicCountLimit: number;
  initNameForLevel0: string;
  initNameForLevel1: string;
...
export interface GuildConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(overrides?: CallOverrides): Promise<[GuildConfigStructOutput]>;
