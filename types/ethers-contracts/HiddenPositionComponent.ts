...
export interface HiddenPositionComponentInterface extends utils.Interface {
  functions: {
...
export interface HiddenPositionComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HiddenPositionComponentInterface;
