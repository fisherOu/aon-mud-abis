...
export type TechConfigGlobalStruct = {
  maxQueueLength: PromiseOrValue<BigNumberish>;
};

export type TechConfigGlobalStructOutput = [number] & {
  maxQueueLength: number;
};

export interface TechConfigGlobalComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "set((uint32))",
    values: [TechConfigGlobalStruct]
  ): string;
  encodeFunctionData(
...
export interface TechConfigGlobalComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechConfigGlobalComponentInterface;
  ...
  functions: {
    ...
    getValue(
      overrides?: CallOverrides
    ): Promise<[TechConfigGlobalStructOutput]>;
    ...
    "set((uint32))"(
      techConfigGlobal: TechConfigGlobalStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  getValue(overrides?: CallOverrides): Promise<TechConfigGlobalStructOutput>;
