...
export interface ReleaseLinearTreasureSystemInterface extends utils.Interface {
  functions: {
...
export interface ReleaseLinearTreasureSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReleaseLinearTreasureSystemInterface;
