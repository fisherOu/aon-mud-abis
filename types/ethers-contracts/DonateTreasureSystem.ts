...
export type DonateTreasureInfoStruct = {
...
export interface DonateTreasureSystemInterface extends utils.Interface {
  ...
  encodeFunctionData(
    ...
    values: [DonateTreasureInfoStruct]
  ): string;
...
export interface DonateTreasureSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DonateTreasureSystemInterface;
  ...
  functions: {
    ...
    executeTyped(
      donateTreasureInfo: DonateTreasureInfoStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
