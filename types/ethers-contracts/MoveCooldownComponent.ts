...
export type MoveCooldownStruct = {
  lastMoveTime: PromiseOrValue<BigNumberish>;
  remainingMovePoints: PromiseOrValue<BigNumberish>;
};

export type MoveCooldownStructOutput = [BigNumber, BigNumber] & {
  lastMoveTime: BigNumber;
  remainingMovePoints: BigNumber;
};

export interface MoveCooldownComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, MoveCooldownStruct]
  ): string;
  encodeFunctionData(
...
export interface MoveCooldownComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MoveCooldownComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[MoveCooldownStructOutput]>;
    ...
    "set(uint256,(uint64,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      moveCooldown: MoveCooldownStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
