...
export type SpaceTimeMarkerStruct = {
  seed: PromiseOrValue<BigNumberish>;
  timeout: PromiseOrValue<BigNumberish>;
};

export type SpaceTimeMarkerStructOutput = [BigNumber, BigNumber] & {
  seed: BigNumber;
  timeout: BigNumber;
};

export interface SpaceTimeMarkerComponentInterface extends utils.Interface {
  functions: {
...
export interface SpaceTimeMarkerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SpaceTimeMarkerComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[SpaceTimeMarkerStructOutput]>;
