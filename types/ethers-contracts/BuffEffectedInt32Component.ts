...
export interface BuffEffectedInt32ComponentInterface extends utils.Interface {
  functions: {
    "authorizeWriter(address)": FunctionFragment;
    "getBuffValue(uint256)": FunctionFragment;
...
export interface BuffEffectedInt32Component extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuffEffectedInt32ComponentInterface;
