...
export interface GuildCrestPlayerComponentInterface extends utils.Interface {
  functions: {
...
export interface GuildCrestPlayerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildCrestPlayerComponentInterface;
