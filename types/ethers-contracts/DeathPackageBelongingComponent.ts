...
export interface DeathPackageBelongingComponentInterface
...
export interface DeathPackageBelongingComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeathPackageBelongingComponentInterface;
