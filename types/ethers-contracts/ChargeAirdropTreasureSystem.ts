...
export interface ChargeAirdropTreasureSystemInterface extends utils.Interface {
  functions: {
    "execute(bytes)": FunctionFragment;
    "executeTyped((uint256,(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[2],uint256[2][2],uint256[2]),(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[2],uint256[2][2],uint256[2]),uint32))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [ChargeTreasureInfoStruct]
  ): string;
...
export interface ChargeAirdropTreasureSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ChargeAirdropTreasureSystemInterface;
  ...
  functions: {
    ...
    executeTyped(
      chargeTreasureInfo: ChargeTreasureInfoStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
