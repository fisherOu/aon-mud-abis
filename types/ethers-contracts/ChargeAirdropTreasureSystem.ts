...
export interface ChargeAirdropTreasureSystemInterface extends utils.Interface {
  functions: {
    ...
    "executeTyped((uint256,(uint256,uint256,uint256,uint256,uint256,uint256[2],uint256[2][2],uint256[2]),(uint256,uint256,uint256,uint256,uint256,uint256[2],uint256[2][2],uint256[2]),uint32))": FunctionFragment;
