...
export interface GuildChargeLinearTreasureSystemInterface
  extends utils.Interface {
  functions: {
    "execute(bytes)": FunctionFragment;
    "executeTyped((uint256,(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256[2],uint256[2][2],uint256[2]),uint32,uint64,uint32,uint256))": FunctionFragment;
...
export interface GuildChargeLinearTreasureSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildChargeLinearTreasureSystemInterface;
