...
export type TreasureEffectGenerateConfigStruct = {
  energyPerArea: PromiseOrValue<BigNumberish>;
  energyPerValue: PromiseOrValue<BigNumberish>;
  basicCooldownTime: PromiseOrValue<BigNumberish>;
  energyPerRange: PromiseOrValue<BigNumberish>;
  basicUsageTimes: PromiseOrValue<BigNumberish>;
  minArea: PromiseOrValue<BigNumberish>;
  maxArea: PromiseOrValue<BigNumberish>;
  minValue: PromiseOrValue<BigNumberish>;
  maxValue: PromiseOrValue<BigNumberish>;
};

export type TreasureEffectGenerateConfigStructOutput = [
  BigNumber,
  BigNumber,
  BigNumber,
  BigNumber,
  ...
  energyPerArea: BigNumber;
  energyPerValue: BigNumber;
  basicCooldownTime: BigNumber;
  energyPerRange: BigNumber;
  basicUsageTimes: number;
  minArea: BigNumber;
  maxArea: BigNumber;
  minValue: BigNumber;
  maxValue: BigNumber;
...
export interface TreasureEffectGenerateConfigComponentInterface
  ...
  functions: {
    ...
    "set(uint256,(uint64,uint64,uint64,uint64,uint32,uint64,uint64,uint64,uint64))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint64,uint64,uint64,uint64,uint32,uint64,uint64,uint64,uint64))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint64,uint64,uint64,uint64,uint32,uint64,uint64,uint64,uint64))",
    values: [PromiseOrValue<BigNumberish>, TreasureEffectGenerateConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface TreasureEffectGenerateConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureEffectGenerateConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TreasureEffectGenerateConfigStructOutput]>;
    ...
    "set(uint256,(uint64,uint64,uint64,uint64,uint32,uint64,uint64,uint64,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      treasureEffect: TreasureEffectGenerateConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
