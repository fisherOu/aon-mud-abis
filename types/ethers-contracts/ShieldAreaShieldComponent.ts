...
export interface ShieldAreaShieldComponentInterface extends utils.Interface {
  functions: {
...
export interface ShieldAreaShieldComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ShieldAreaShieldComponentInterface;
