...
export interface DeathTriggerSystemInterface extends utils.Interface {
  functions: {
...
export interface DeathTriggerSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeathTriggerSystemInterface;
