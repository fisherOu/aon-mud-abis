...
export interface ResourceConfigAreaComponentInterface extends utils.Interface {
  functions: {
...
export interface ResourceConfigAreaComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceConfigAreaComponentInterface;
