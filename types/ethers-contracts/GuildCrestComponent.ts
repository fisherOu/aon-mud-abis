...
export type GuildCrestStruct = {
  level: PromiseOrValue<BigNumberish>;
  name: PromiseOrValue<string>;
  contribute: PromiseOrValue<BigNumberish>;
  allocate: PromiseOrValue<BigNumberish>;
  createTime: PromiseOrValue<BigNumberish>;
};

export type GuildCrestStructOutput = [
  number,
  string,
  BigNumber,
  BigNumber,
...
export interface GuildCrestComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint32,string,uint256,uint256,uint64))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint32,string,uint256,uint256,uint64))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint32,string,uint256,uint256,uint64))",
    values: [PromiseOrValue<BigNumberish>, GuildCrestStruct]
  ): string;
  encodeFunctionData(
...
export interface GuildCrestComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildCrestComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[GuildCrestStructOutput]>;
