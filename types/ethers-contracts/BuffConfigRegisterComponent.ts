...
export interface BuffConfigRegisterComponentInterface extends utils.Interface {
  functions: {
...
export interface BuffConfigRegisterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BuffConfigRegisterComponentInterface;
