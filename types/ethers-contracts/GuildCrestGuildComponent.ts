...
export interface GuildCrestGuildComponentInterface extends utils.Interface {
  functions: {
...
export interface GuildCrestGuildComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildCrestGuildComponentInterface;
