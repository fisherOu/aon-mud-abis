...
export interface GuildUnboundTreasureSystemInterface extends utils.Interface {
  functions: {
...
export interface GuildUnboundTreasureSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: GuildUnboundTreasureSystemInterface;
