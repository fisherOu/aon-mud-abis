...
export type ResourceMiningStructOutput = [BigNumber, BigNumber] & {
  remain: BigNumber;
  cache: BigNumber;
};

export interface ResourceMiningComponentInterface extends utils.Interface {
  functions: {
...
export interface ResourceMiningComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceMiningComponentInterface;
