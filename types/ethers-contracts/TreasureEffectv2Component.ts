...
export type TreasureEffectStructOutput = [BigNumber, number, number] & {
  effectType: BigNumber;
  area: number;
  value: number;
};

export interface TreasureEffectv2ComponentInterface extends utils.Interface {
  functions: {
...
export interface TreasureEffectv2Component extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureEffectv2ComponentInterface;
