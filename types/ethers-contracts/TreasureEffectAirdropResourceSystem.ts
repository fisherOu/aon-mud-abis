...
export interface TreasureEffectAirdropResourceSystemInterface
...
export interface TreasureEffectAirdropResourceSystem extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TreasureEffectAirdropResourceSystemInterface;
