...
export type AttackTimerStruct = {
  cooldownTimeout: PromiseOrValue<BigNumberish>;
  chargingTimeout: PromiseOrValue<BigNumberish>;
};

export type AttackTimerStructOutput = [BigNumber, BigNumber] & {
  cooldownTimeout: BigNumber;
  chargingTimeout: BigNumber;
};

export interface AttackTimerComponentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [PromiseOrValue<BigNumberish>, AttackTimerStruct]
  ): string;
  encodeFunctionData(
...
export interface AttackTimerComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AttackTimerComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[AttackTimerStructOutput]>;
