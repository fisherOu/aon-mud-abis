...
export type ResourceConfigStruct = {
  ...
  recuitTimeMax: PromiseOrValue<BigNumberish>;
  recuitTimeMin: PromiseOrValue<BigNumberish>;
  maxBatch: PromiseOrValue<BigNumberish>;
};
...
export type ResourceConfigStructOutput = [
  ...
  difficultMax: number;
  difficultMin: number;
  recuitTimeMax: BigNumber;
  recuitTimeMin: BigNumber;
  maxBatch: BigNumber;
};

export interface ResourceConfigv2ComponentInterface extends utils.Interface {
  functions: {
    ...
    "set((uint256,uint256,uint8,uint8,uint64,uint64,uint256))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set((uint256,uint256,uint8,uint8,uint64,uint64,uint256))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set((uint256,uint256,uint8,uint8,uint64,uint64,uint256))",
...
export interface ResourceConfigv2Component extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceConfigv2ComponentInterface;
