...
export interface TechConfigRegisterComponentInterface extends utils.Interface {
  functions: {
...
export interface TechConfigRegisterComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechConfigRegisterComponentInterface;
