...
export interface ResourceNonceMarkComponentInterface extends utils.Interface {
  functions: {
...
export interface ResourceNonceMarkComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceNonceMarkComponentInterface;
