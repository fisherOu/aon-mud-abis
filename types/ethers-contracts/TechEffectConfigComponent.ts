...
export type TechEffectConfigStruct = {
  techEffectType: PromiseOrValue<BigNumberish>;
  asset: PromiseOrValue<string>;
  name: PromiseOrValue<string>;
  buffRareType: PromiseOrValue<BigNumberish>;
};

export type TechEffectConfigStructOutput = [
  number,
  string,
  string,
  BigNumber
] & {
  techEffectType: number;
  asset: string;
  name: string;
  buffRareType: BigNumber;
};

export interface TechEffectConfigComponentInterface extends utils.Interface {
  functions: {
    ...
    "set(uint256,(uint32,string,string,uint64))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "remove"
      | "set(uint256,bytes)"
      | "set(uint256,(uint32,string,string,uint64))"
      | "transferOwnership"
      | "unauthorizeWriter"
      | "world"
      | "writeAccess"
  ...
  encodeFunctionData(
    functionFragment: "set(uint256,(uint32,string,string,uint64))",
    values: [PromiseOrValue<BigNumberish>, TechEffectConfigStruct]
  ): string;
  encodeFunctionData(
...
export interface TechEffectConfigComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TechEffectConfigComponentInterface;
  ...
  functions: {
    ...
    getValue(
      entity: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
    ): Promise<[TechEffectConfigStructOutput]>;
    ...
    "set(uint256,(uint32,string,string,uint64))"(
      entity: PromiseOrValue<BigNumberish>,
      techEffect: TechEffectConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
