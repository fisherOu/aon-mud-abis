...
export interface HPLimitComponentInterface extends utils.Interface {
  functions: {
...
export interface HPLimitComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HPLimitComponentInterface;
