...
export interface SilverAmountComponentInterface extends utils.Interface {
  functions: {
...
export interface SilverAmountComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SilverAmountComponentInterface;
