...
export interface ResourceRecuitComponentInterface extends utils.Interface {
  functions: {
...
export interface ResourceRecuitComponent extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ResourceRecuitComponentInterface;
