...
export interface PickUpTreasurev2SystemInterface extends utils.Interface {
  functions: {
...
export interface PickUpTreasurev2System extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PickUpTreasurev2SystemInterface;
